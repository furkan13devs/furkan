...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>Merhaba benim adım<span class='bold'><a class='alink'>FURKAN</a>.</span><br><br><span class='bold'> 👨🏻‍💻📚</span><br><br><br><br> <span class='bold'>'help'</span> HAKKIMDA BİLGİ ALMAK İÇİN YAZ.<br>");
            }, 2000);
            break;
        case "help":
            sendTextMessage("<span class='sk'>hakkımda bilgi almak için anahtar kelimeleri yaz...<br>e.g<br><span class='bold'>'skills'</span> - becerilerim için<br><span class='bold'>''</span> - <br><span class='bold'>''</span> - to <br><span class='bold'>''</span> - <br><span class='bold'>'contact'</span> - iletişim bilgilerim<br><span class='bold'>''</span> - <br><span class='bold'>'clear'</span> - to clear conversation<br><span class='bold'>'about'</span> - to know about this site</span>");
            break;
        case "resume":
            sendTextMessage(resumeString);
            break;
        case "skills":
            sendTextMessage("<span class='sk'>Yazılım,siber güvenlik ve etik hacking eğitimi alıyorum..<br><br>I sık kullandığım yazılım dilleri :<br><span class='bold'>Java<br>C++<br>C<br>PHP<br>Kotlin<br>Dart<br>Python<br>CSS<br>HTML</span><br><br>Ayrıca aşağıdaki framworklerede ilgim var :<span class='bold'><br>Android<br>Flutter<br>ReactJs<br>GTK</span><br><br>Günlük sürücü olarak <span class='bold'>Arch Linux</span>'u HP Pavilion 15-ec0xxx cihazımda günlük sürücü olarak kullanıyorum
İşletim Sistemi:Arch Linux
DE:Gnome(Daha sık) Kde(sık sık)
Favori IDE: VSCode</span>");
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by <a class='alink' target='_blank' href='https:\/\/instagram.com/sw6nt3x/'><span class='bold'>Vinayak Patil</a> with ❤️</span>");
            break;
        case "contact":
